                        ...
                        <div class="event-rapper">
                            ...
                            <div class="event-content">
                                <ul class="event-nav" role="tablist">
                                    <li>
                                        <a href="#ev1" aria-controls="ev1" role="tab" data-toggle="tab" class="waves-effect waves-teal-2">
                                            <h4>monday</h4>
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane  active" id="ev1">
                                        <div class="single-tab-content">
                                            <div class="single-parent">
                                                <div class="single-left-child">
                                                    <img src="assets/images/sec-img/business-man.jpg" alt="" class="img-circle">
                                                    <h3>Julfikar hasnat</h3>
                                                    <h5>Managing Derictor Of Anex</h5>
                                                </div>
                                                <div class="single-right-child">
                                                    <ul>
                                                        <li><a href="#"> <i class="fa fa-clock-o"></i> <span class="block-style">9.00am-11.59am</span></a></li>
                                                        <li><a href="#"> <i class="fa fa-location-arrow"></i> <span class="block-style">Convention Center , U S A</span> </a></li>
                                                    </ul>
                                                    <a href="#">
                                                        <h2>Feugiat nulla facilisis at vero eros et accumsan</h2>
                                                    </a>
                                                    <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus paclaram anteposuerit litterarum formas humanitatis per... <a href="#">contiune reading..</a></p>
                                                </div>
                                            </div>
                                            <!-- end single parent -->
                                            <div class="single-parent reversitem">
                                                <div class="single-left-child">
                                                    <img src="assets/images/sec-img/business-man.jpg" alt="" class="img-circle">
                                                    <h3>Julfikar hasnat</h3>
                                                    <h5>Managing Derictor Of Anex</h5>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="ev2">
                                        <div class="single-tab-content">
                                            <div class="single-parent no">
                                                <div class="single-left-child">
                                                    <img src="assets/images/sec-img/business-man.jpg" alt="" class="img-circle">
                                                    <h3>Julfikar hasnat</h3>
                                                    <h5>Managing Derictor Of Anex</h5>
                                                ...
                                                <div class="single-right-child">
                                                    ...
                                                    <p>Claritas est etiam processus dynamicus, qui sequit... <a href="#">contiune reading..</a></p>
                                                </div>
                                            </div>
                                            <!-- end single parent -->
                                        </div>
                                    ...
                                    <!-- end single tab content -->
                                    <div role="tabpanel" class="tab-pane" id="ev3">
                                        <div class="single-tab-content">
                                            <div class="single-parent">
                                                <div class="single-left-child">
                                                    <img src="assets/images/sec-img/business-man.jpg" alt="" class="img-circle">
                                            ...
                                            <!-- end single parent -->
                                            <div class="single-parent reversitem no">
                                                <div class="single-left-child">
                                                    <img src="assets/images/sec-img/business-man.jpg" alt="" class="img-circle">
                                                    <h3>Julfikar hasnat</h3>
                                                    <h5>Managing Derictor Of Anex</h5>
                                    ...
                                    <!-- end single tab content -->
                                    <div role="tabpanel" class="tab-pane" id="ev4">
                                        <div class="single-tab-content">
                                            <div class="single-parent no">
                                                <div class="single-left-child">
                                                    <img src="assets/images/sec-img/business-man.jpg" alt="" class="img-circle">
                                    ...
                                    <!-- end single tab content -->
                                    <div role="tabpanel" class="tab-pane" id="ev5">
                                        <div class="single-tab-content">
                                            <div class="single-parent no">
                                                <div class="single-left-child">
                                                    <img src="assets/images/sec-img/business-man.jpg" alt="" class="img-circle">
                                    ...
                                    <!-- end single tab content -->
                                    <div role="tabpanel" class="tab-pane" id="ev6">
                                        <div class="single-tab-content">
                                            <div class="single-parent no">
                                                <div class="single-left-child">
                                                    <img src="assets/images/sec-img/business-man.jpg" alt="" class="img-circle">
        ...
        <ul class="photo-gal">
            <div class="gallery-active owl-carousel">
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl1.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl1.jpg">
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl2.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl2.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl3.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl3.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl4.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl4.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl5.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl5.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl6.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl6.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl7.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl7.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl8.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl8.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl9.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl9.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                ...
                <!-- end single gallery  -->
                <li class="single-photo-gallery waves-effect waves-teal-3">
                    <img src="assets/images/gallery/gl10.jpg" alt="">
                    <div class="gallery-hover-1">
                        <a class="img-poppu" href="assets/images/gallery/gl10.jpg">
                            <i class="fa fa-search-plus"></i>
                        </a>
                        <h3>malaysia tour <span>2012</span></h3>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="single-testimonilas">
                            <div class="testi-thumb">
                                <img src="assets/images/testi/t1.jpg" alt="" class="img-circle">
                            </div>
